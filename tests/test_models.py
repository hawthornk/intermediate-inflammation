...
@pytest.mark.parametrize(
    "test, expected",
    [
        ([[1,2,3],[4,5,6],[7,8,9]], [[0.14, 0.29, 0.43],[0.5, 0.62, 0.75],[0.78, 0.89, 1.0]])
    ]

)
def test_patient_normliase(test, expected):
    """Test normalisasiotn worked for arrays of one and positive intergeres.
    Assume test accuracy of 2 dp is suffiecnet"""
